...
public class TT {
    ...
    public void getTokenByCode() throws IOException {
        ...
        String[] params = new String[]{
                ...
                "code", "GEtKSZ",//这个code是从getCode()方法获取的
    ...
    public void checkToken() throws IOException {
        String[] params = new String[]{
                "token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOlsicmVzb3VyY2UxIl0sInVzZXJfbmFtZSI6InVzZXIiLCJzY29wZSI6WyJzY29wZTEiXSwiZXhwIjoxNjcyMjA5ODU4LCJhdXRob3JpdGllcyI6WyJ1c2VyIl0sImp0aSI6Ijc4OGEyM2MzLTNlMTAtNDA1ZC1iZmNhLTc4Nzg5N2VjY2Q5YSIsImNsaWVudF9pZCI6ImNsaWVudDEifQ.EcFEk0vUNxP5RjyXaKyItRlMSbuFgSFDrxQ3ih4L6h0",
        };
    ...
    public void getResourceByToken() throws IOException {
        Map<String, String> head = RootUtil.buildMap("Authorization", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOlsicmVzb3VyY2UxIl0sInVzZXJfbmFtZSI6InVzZXIiLCJzY29wZSI6WyJzY29wZTEiXSwiZXhwIjoxNjcyMjA5ODU4LCJhdXRob3JpdGllcyI6WyJ1c2VyIl0sImp0aSI6Ijc4OGEyM2MzLTNlMTAtNDA1ZC1iZmNhLTc4Nzg5N2VjY2Q5YSIsImNsaWVudF9pZCI6ImNsaWVudDEifQ.EcFEk0vUNxP5RjyXaKyItRlMSbuFgSFDrxQ3ih4L6h0");
